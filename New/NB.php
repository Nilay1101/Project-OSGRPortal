...
<head>
    ...
    <title>| OSGRP - Notice Board |</title>
    ...
    <link rel="stylesheet" type="text/css" href="blog_left_sidebar5f15.php??stylesheets/colors/color1.css" id="colors">
...
<body class="header-sticky"> 
  <header id="header" class="header">
	...
	<h2 class="page-title-captions">Notice Board</h2>
	</div>
	</div>
	</div>
    ...
    <section id="sec-post-brsidebar" class="section blog-posts br-sidebar">
        <div class="container">
            <div class="row">
                <div class="col-md-9 padding-l100px">
                    <article class="post">
